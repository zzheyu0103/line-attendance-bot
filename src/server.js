...
app.get('/admin', (req, res) => {
  ...
  res.send(page('LINE 打卡管理', `<header><div><h1>出勤管理</h1><p>${month} 月報表</p></div><nav><a href="/admin/schedules">排班中心</a><a href="/admin/payroll?month=${month}">薪資中心</a><a href="/admin/anomalies">異常中心</a><a href="/admin/audit">稽核紀錄</a><a href="/admin/export?month=${month}">匯出 CSV</a><a href="/admin/backup">備份資料</a><a href="/admin/logout">登出</a></nav></header>
    <nav class="section-nav"><a href="#overview">總覽</a><a href="#tools">設定與補登</a><a href="#leave">請假</a><a href="#employees">員工紀錄</a><a href="/admin/schedules">前往排班中心</a></nav>
    ...
    <section class="operations"><article id="leave"><h2>請假審核</h2><div class="table-wrap"><table><thead><tr><th>日期</th><th>員工</th><th>原因</th><th>狀態</th><th></th></tr></thead><tbody>${leaveRows || '<tr><td colspan="5">尚無請假申請</td></tr>'}</tbody></table></div></article></section>
