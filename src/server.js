...
app.get('/admin', (req, res) => {
  ...
  res.send(page('LINE 打卡管理', `<header><div><h1>出勤管理</h1><p>${month} 月報表</p></div><nav><a href="/admin/schedules">排班中心</a><a href="/admin/leaves">請假中心${pendingLeaves ? ` (${pendingLeaves})` : ''}</a><a href="/admin/payroll?month=${month}">薪資中心</a><a href="/admin/anomalies">異常中心</a><a href="/admin/audit">稽核紀錄</a><a href="/admin/export?month=${month}">匯出 CSV</a><a href="/admin/backup">備份資料</a><a href="/admin/logout">登出</a></nav></header>
    <nav class="section-nav"><a href="#overview">總覽</a><a href="#tools">設定與補登</a><a href="#employees">員工紀錄</a><a href="/admin/schedules">排班中心</a><a href="/admin/leaves">請假中心</a></nav>
